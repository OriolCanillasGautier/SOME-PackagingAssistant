...
def get_stp_dimensions(file_path):
    ...
    try:
        ...
        print(f"\nANALYZING REAL GEOMETRY: {filename}")
        print("=" * 50)
        ...
        if real_geometry_analysis and real_geometry_analysis.get('total_faces', 0) > 6:
            print(f"COMPLEX GEOMETRY DETECTED!")
            print(f"   Faces: {real_geometry_analysis['total_faces']}")
            print(f"   Vertices: {real_geometry_analysis['total_vertices']}")
            print(f"   Parallel face pairs: {real_geometry_analysis['parallel_face_pairs']}")
            print(f"   Real volume: {real_geometry_analysis['real_volume']:.2f} mm³")
            print(f"   Bounding box volume: {real_geometry_analysis['bbox_volume']:.2f} mm³")
            print(f"   Volume efficiency: {real_geometry_analysis['volume_efficiency']:.3f}")
            print(f"   Complexity score: {real_geometry_analysis['complexity_score']:.2f}")
        ...
        print("Simple geometry detected, using standard method...")
        ...
        print(f"ERROR: Error processing STP file {file_path}: {e}")
        return None
