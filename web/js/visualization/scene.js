...
export class SceneManager {
    ...
    async addPackedSTLHeightMapAsync({
        ...
        const totalElapsed = ((_tPhase2End - _tPhase2Start) / 1000).toFixed(2);
        console.log(`[Timing] TOTAL: ${totalElapsed}s`);
        ...
        console.log(`[HeightMapAsync]   all organic, maxTry=${effectiveMaxTry}, skips=${consecutiveSkips}, subStep=${subStep}, sq=${sq}`);
