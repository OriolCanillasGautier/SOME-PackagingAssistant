...
const translations = {
    ca: {
        ...
        page: 'Pàgina',
        estimatedWeight: 'Pes estimat (material)',
        estimatedTotalWeight: 'Pes total estimat',
        materialDensity: 'Densitat material'
    },
    en: {
        ...
        page: 'Page',
        estimatedWeight: 'Estimated weight (material)',
        ...
        <div class="info-row">
            <div class="info-box">
                ...
                <table>
                    ...
                    <tr><td>${this.t.volume}</td><td>${pieceVolume.toFixed(2)} cm³${meshVolume > 0 ? ' (real)' : ' (bbox)'}</td></tr>
                </table>
            </div>
            <div class="info-box">
